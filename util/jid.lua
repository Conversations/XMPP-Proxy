...
local nodeprep = nil; -- require "util.encodings".stringprep.nodeprep;
local nameprep = nil --require "util.encodings".stringprep.nameprep;
local resourceprep = nil -- require "util.encodings".stringprep.resourceprep;
